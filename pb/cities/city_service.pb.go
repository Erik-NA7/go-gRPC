...
var file_city_service_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6d, 0x22, 0x00, 0x30, 0x01, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x62, 0x2f, 0x63, 0x69, 0x74,
...
var file_city_service_proto_goTypes = []any{
	(*Id)(nil),           // 0: cities.Id
	(*CityInput)(nil),    // 1: cities.CityInput
	(*City)(nil),         // 2: cities.City
...
var file_city_service_proto_depIdxs = []int32{
	...
	1, // 1: cities.CitiesService.Create:input_type -> cities.CityInput
	2, // 2: cities.CitiesService.Update:input_type -> cities.City
	0, // 3: cities.CitiesService.Delete:input_type -> cities.Id
	3, // 4: cities.CitiesService.GetCities:input_type -> cities.EmptyMessage
	2, // 5: cities.CitiesService.GetCity:output_type -> cities.City
	2, // 6: cities.CitiesService.Create:output_type -> cities.City
	2, // 7: cities.CitiesService.Update:output_type -> cities.City
	4, // 8: cities.CitiesService.Delete:output_type -> cities.MyBoolean
	5, // 9: cities.CitiesService.GetCities:output_type -> cities.CitiesStream
